...
const RequirementCard: React.FC<RequirementProps> = ({ title, description }) => {
    return(
        <div className="flex flex-col bg-gray-80/50 w-[328px] h-[158px] pad:w-[384px] pad:h-[170px] px-[40px] py-[32px] gap-[16px] rounded-[16px] justify-center items-center text-center">
