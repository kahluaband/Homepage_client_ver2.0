...
const MainContainer = () => {
  return (
    <>
      <div className="min-[360px]:w-full min-[834px]:w-[786px] max-w-[1200px] min-h-[320px] flex flex-col bg-gray-90 items-center min-[360px]:rounded-none min-[834px]:rounded-3xl mt-[16px] mb-[32px]">
