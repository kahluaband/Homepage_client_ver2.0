const RoomNotice = () => {
  return (
    <div className="my-4 flex flex-col gap-6">
      ...
      <ul className="list-disc pl-5 space-y-0.75 text-gray-40">
        ...
        <li>동아리방은 깔루아 외에도 다른 교내 밴드 소모임이 함께 사용합니다. 다른 밴드의 소유물을 사용하지 않도록 깔루아 스티커가 붙어있는 장비만 사용하시기 바랍니다.</li>
        <li>동아리방 사용 후 난방, 에어컨, 선풍기 전원을 꼭 꺼주시고, 절전 부탁드립니다.</li>
        <li>동아리방 사용에 대한 관리는 현 기수 기장이 담당하고 있습니다. 따라서 기타 문의사항은 깔루아 SNS 또는 기장에게 문의주시면 감사하겠습니다.</li>
      </ul>
    </div>
  );
};
