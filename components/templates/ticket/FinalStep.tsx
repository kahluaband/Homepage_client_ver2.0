    ...
    <div className="flex flex-col mt-10 w-full">
      <div className="flex flex-row w-full">
        <div className="flex flex-col pad:ml-12 ml-4">
          <div className="text-gray-50 font-light text-[14px] pad:text-[18px] leading-[27px]">
            {priceValue === 0
              ? `무료 x ${amount}매`
          ...
          <div className="flex flex-row w-[84px] pad:w-[289px] h-[27px] pad:h-[48px] gap-4 items-center">
            <p className="hidden pad:flex w-[137px] text-gray-70 font-normal text-[24px] leading-9">
              최종 결제 금액
            </p>
            <div className="text-primary-50 font-medium text-[18px] pad:text-[32px] leading-[48px] whitespace-nowrap">
        ...
        <button
          ...
          className="mr-4 pad:mr-12 pad:mt-[20px] w-[182px] pad:w-[384px] h-[52px] pad:h-[59px] flex flex-shrink-0 text-center justify-center items-center ml-auto rounded-xl text-[16px] pad:text-[18px] font-normal text-gray-0 bg-primary-50"
        >
          예매하기
        </button>
      </div>
