  ...
  return (
    <div className="font-pretendard relative mx-auto w-full pad:w-[786px] dt:w-[1200px] h-auto pt-4 flex flex-col justify-center">
      ...
      <section className="pad:mt-[72px] ph:mt-[32px] flex">
        <div className="pad:flex-col pad:grid gap-y-6">
          <Card
            bgColor="bg-gray-90"
            title1="새내기 첫 합주"
            title2=""
        ...
        {/* dt */}
        <div className="ml-6 dt:block pad:hidden">
          <ImageBox
            width="dt:w-[384px] pad:w-[381px]"
        ...
        <div className="ml-6 dt:grid gap-y-6 pad:hidden">
          <ImageBox
            width="dt:w-[384px] pad:w-[381px]"
            height="dt:h-[223px] pad:h-[223px]"
            imageSrc={ensemble2}
        ...
        {/* pad */}
        <div className="ml-[21px] dt:hidden pad:grid gap-y-[28px]">
          <ImageBox
            width="dt:w-[384px] pad:w-[381px]"
            height="dt:h-[223px] pad:h-[223px]"
            imageSrc={ensemble3}
      ...
      <section className="pad:mt-[200px] ph:mt-[104px] flex">
        {/* pad */}
        <div className="mr-[21px] dt:hidden pad:grid gap-y-[28px]">
          <ImageBox
            width="dt:w-[384px] pad:w-[381px]"
            height="dt:h-[223px] pad:h-[223px]"
            imageSrc={concert1}
      ...
      {/* MT, 번개, 여행 */}
      <section className="pad:mt-[200px] ph:mt-[104px] flex mb-[160px]">
        {/* pad */}
        <div className="mr-[21px] dt:hidden pad:grid gap-y-[28px]">
          <ImageBox
            width="dt:w-[384px] pad:w-[381px]"
