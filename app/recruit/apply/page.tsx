...
const page = () => {
  ...
  return (
    //반응형에 따라 mx 수정 필요
    <div className="flex flex-col relative top-16 items-center justify-center text-center mx-[200px] h-[1800px] mt-4 ">
        ...
        <div className="w-full h-auto rounded-b-xl border border-gray-15 flex flex-col px-12 py-10 text-left">
          ...
          <ul className="text-gray-40 text-[18px] ml-6 pt-2 list-disc list-inside">
            <li>수집된 모든 개인정보는 모집이 마감된 후 파기됩니다.</li>
          </ul>
        </div>
        <Link href="/" className={`flex justify-center items-center text-center h-[60px] w-[384px] text-[18px] rounded-[12px] mt-[40px] mb-[288px] ${isChecked ? "bg-primary-50 text-gray-0" : "bg-gray-10 text-gray-40"}`}>다음</Link>
    </div>
  )
};
