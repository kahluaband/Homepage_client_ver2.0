  ...
  return (
    <div className="flex flex-col relative top-16 items-center justify-start text-center mx-auto w-full pad:w-[786px] dt:w-[996px] h-auto mt-4">
        <div className="h-[200px] w-full pad:rounded-t-xl bg-gray-90 flex flex-col mx-aut">
          <p className="mt-10 text-gray-0 text-center text-[24px] pad:text-[32px] font-semibold leading-[48px]">지원 전 필독사항</p>
          <p className="mt-4 text-gray-20 text-center text-[16px] pad:text-[18px] font-normal leading-[27px] hidden pad:block">안녕하세요! 홍익대학교 컴퓨터공학과 밴드학회 깔루아입니다.</p>
          <p className="text-gray-20 text-center text-[16px] pad:text-[18px]  font-normal leading-[27px] max-pad:px-6">단순 인원 집계용으로 사용되는 가입 지원서이므로 부담 없이 작성해 주시면 됩니다.</p>
        </div>
        <div className="w-full h-auto pad:rounded-b-xl pad:border border-gray-15 flex flex-col px-4 pad:px-12 py-10 text-left">
          ...
          <div className="w-full h-auto px-6 py-5 bg-gray-5 rounded-[12px]">
            <Checkbox id="notice" checked={isChecked} onChange={handleCheckboxChange} className="">위 필독사항을 모두 숙지했으며, 개인정보 수집에 동의합니다.</Checkbox>
          </div>
...
const Activity = () => {
  return (
    <div className="text-left h-auto">
      <p className="text-[18px] pad:text-[20px] font-semibold text-gray-90">깔루아 활동</p>
...
const VocalNotice = () => {
  return (
    <div className="mt-12 text-left h-auto">
      <p className="text-[18px] pad:text-[20px] font-semibold text-gray-90">보컬 세션 지원</p>
      <ul className="text-[16px] pad:text-[18px] text-gray-60 text-left mt-2 list-outside list-disc ml-[18px]">
        <li>보컬 지원자의 경우 대면 오디션과 별개로 <span className="text-gray-80">지원 영상 제출이 필수</span>입니다.</li>
...
const OtherSessionNotice = () => {
  return (
    <div className="mt-12 mb-10 text-left h-auto">
      <p className="text-[18px] pad:text-[20px] font-semibold text-gray-90">드럼 / 기타 / 베이스 / 신디사이저 세션 지원</p>
      <ul className="text-[16px] pad:text-[18px] text-gray-60 text-left mt-2 list-outside list-disc ml-[18px]">
...
const Warning = () => {
  return (
    <div className="mt-10 mb-10 text-left h-auto">
      <p className="text-[18px] pad:text-[20px] font-semibold text-danger-40">! 주의사항</p>
