...
const Freshman_tickets: React.FC = () => {
    ...
    return (
        <div className="flex flex-col relative top-16 items-center justify-start text-center mx-[200px] h-auto mt-4 ">
            ...
            <Link href="/" className="flex justify-center items-center text-center h-[60px] w-[384px] text-[18px] rounded-[12px] mt-[40px] mb-[288px] bg-gray-5 text-gray-60">메인으로 돌아가기</Link>
        </div>
    );
};
