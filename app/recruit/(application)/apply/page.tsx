...
const page = () => {
  ...
  return (
    <div className="flex flex-col relative top-16 items-center justify-start text-center mx-auto w-full pad:w-[786px] dt:w-[996px] h-auto mt-4 ">
        ...
        <button onClick={(e) => setShowLastCheckModal(true)} disabled={!isComplete} className={`flex justify-center items-center text-center h-[60px] w-[328px] pad:w-[384px] text-[18px] rounded-[12px] mt-[40px] ph:mb-[100px] pad:mb-[140px] dt:mb-[180px] ${isComplete ? "bg-primary-50 text-gray-0" : "bg-gray-10 text-gray-40 cursor-not-allowed"}`}>제출하기</button>
