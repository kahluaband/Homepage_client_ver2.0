...
const FAQ = () => {
    ...
    return (
      <div className="bg-gradient-to-b from-gray-5 to-primary-0 flex flex-col justify-center items-center text-center h-full pt-40 pb-[324px]">
        <div>
        ...
        <div className="pt-16 flex flex-col items-start">
          ...
          >
            <AccordionSummary
              ...
              id="panel1-header"
              className={`p-8 text-[18px] text-left ${expanded === "panel1" ? "text-gray-0" : "text-gray-80"}`}
            >
              <p className={`pr-2 ${expanded === "panel1" ? "text-gray-0" : "text-primary-50"}`}>Q.</p>
              <p>다룰 줄 아는 악기가 없지만 깔루아에 들어가고 싶어요. 이런 제가 깔루아에 지원해도 될까요?</p>
            </AccordionSummary>
            <AccordionDetails className="text-primary-10 text-[18px] text-left flex flex-row px-8 pb-8">
          ...
          >
            <AccordionSummary
              ...
              id="panel1-header"
              className={`p-8 text-[18px] text-left ${expanded === "panel2" ? "text-gray-0" : "text-gray-80"}`}
            >
          ...
          >
            <AccordionSummary
              ...
              id="panel1-header"
              className={`p-8 text-[18px] text-left ${expanded === "panel3" ? "text-gray-0" : "text-gray-80"}`}
            >
