      ...
      <div className="font-pretendard w-full pt-[64px] flex flex-col items-center">
            ...
            <section className="w-[252px] h-8 rounded-[32px] bg-gray-0">
              {typeArr.map((typeName) => (
                ...
                >
                  <span
                    key={typeName}
                    className={`${type === typeName ? 'text-gray-0' : 'text-gray-50'} " text-center font-pretendard text-[16px] font-normal leading-6 "`}
                  >
                    {typeName}
                  </span>
                </div>
        ...
        <section className="w-full h-full flex flex-col items-center">
          <div className="w-[1200px] h-[51px] bg-gray-90 rounded-t-3xl mt-8 font-pretendard flex justify-start items-center px-5">
            <div className="min-w-[94px] text-center text-lg font-normal text-gray-0">
              상태
            </div>
            <div className="min-w-[186px] text-center text-lg font-normal text-gray-0">
              예매 번호
            </div>
            <div className="min-w-[120px] text-center text-lg font-normal text-gray-0">
              이름
            </div>
            <div className="min-w-[160px] text-center text-lg font-normal text-gray-0">
              전화번호
            </div>
            <div className="min-w-[120px] text-center text-lg font-normal text-gray-0">
              매수
