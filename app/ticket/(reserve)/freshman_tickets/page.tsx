import MemberSelection from "@/components/templates/MemberSelection";

const Reserve= () => {
    return (
    <div className="h-[2000px] w-[996px] flex flex-col relative mx-auto top-16 mt-4 ">
        ...
        <div className="h-[1395px] w-full rounded-b-xl border border-gray-15 flex flex-col mx-auto">
            <div className="mx-12 flex flex-col">
                ...
                <div className="h-[1px] bg-gray-15 flex flex-shrink-0 relative"/>
            </div>
        </div>
    </div>
    );
