...
const Page = () => {
  ...
  return (
    <div className="flex relative flex-col top-16 h-[1100px] w-[768px] dt:w-[1200px] mx-auto">
      <div className="flex flex-row mt-8 h-[328px] dt:h-[376px] justify-start dt:justify-center">
        <Image src="/image/ticket/Poster.svg" alt="포스터사진" width={282} height={376} className="w-[246px] h-[328px] dt:w-[282px] dt:h-[376px] flex flex-shrink-0 rounded-xl"/>
        <div className="flex flex-col mt-2 ml-8">
          ...
          <Link href="/ticket/search/" className="ml-[56px] mt-[24px] w-[280px] h-[60px] hidden dt:flex flex-shrink-0 text-center items-center justify-center text-gray-0 bg-primary-50 rounded-xl text-[18px] font-medium">예매 조회/취소</Link>
        </div>
        <div className="hidden dt:flex flex-col ml-[164px] mt-[120px] h-[282px]">
      ...
      <div className="w-[100%] flex flex-row gap-[18px] mt-4">
