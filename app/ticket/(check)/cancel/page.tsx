...
const ReservationDetails = () => {
    ...
    return (
        <div className={`w-full pad:w-[786px] dt:w-[996px] flex flex-col relative mx-auto top-20 ${dynamicHeightClass}`}>
            <div className="h-[200px] w-full pad:rounded-t-xl bg-gray-90 flex mx-auto items-center justify-center ">
                <p className="h-12 text-gray-0 text-center text-2xl font-semibold leading-[48px]">예매가 취소되었습니다.</p>
            </div>
            <div className="pad:h-[594px] dt:h-[500px] w-full pad:rounded-b-xl pad:border pad:border-gray-15 flex flex-col mx-auto">
